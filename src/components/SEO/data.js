...
const data = {
  ...
  blog: {
    ...
    description: 'Bienvenue sur le blog de DeviensDev. Vécu, tuyaux, vision, les professionnels du dev témoignent pour vous préparer à votre futur carrière de développeur.',
  },
  ...
  formations: {
    ...
    description: 'Quelles formations pour devenir développeur ? Trouve ici prochainement le listing de formation par région et par métier',
  },
  ...
  mainInitiation: {
    ...
    description: "HTML, CSS, PHP et Javascript suis nos différents parcours d'initiations au code et découvre les technologies utilisées pour le développement.",
  },

  // Page : HTML
  initiationHTML: {
    title: 'HTML, découvre ce langage informatique et entraine toi à coder',
    description: "Se renseigner c'est bien, s'initier c'est mieux. Arpente notre parcours d'initiation au HTML : leçons et petits exercices pour te familiariser avec cette techno !",
    type: 'article',
  },
  ...
  initiationCSS: {
    ...
    description: "Après le HTML, place au CSS. Définition, leçons, excercices, familiarise toi à ce langage informatique et entraine toi à coder en suivant le parcours d'initiation",
  },
  ...
  contribuer: {
    ...
    description: 'Avis à tous les professionnels du développement qui veulent partager leurs connaissances et leur passion. Devenez contributeur de DeviensDev !',
  },

  // À propos de nous | Mentions légales
  aboutUs: {
    title: "DeviensDev un site concocté avec passion par l'école O'clock",
    description: "Grâce à l'initiative et au soutien du Feder, O'clock a créé la plateforme DeviensDev qui vise à informer et faire découvrir le métier de développeur.",
  },
};
