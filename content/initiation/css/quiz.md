...
quizzes: [
  ...
  },
  {
    ...
    result: [0],
    explanation: "Pour centrer un text il faut utiliser la propritété css text-align: center;."
  },
  {
    id: 4,
    type: 'radio',
    label: "Quelle propriété CSS doit-on utiliser pour forcer un texte à être en majuscule ?",
    answers: [
    ...
    result: [3],
    explanation: "Afin de forcer un texte a être en majuscule, il faut utiliser la propriété css text-transform: uppercase"
  },
  {
    id: 5,
    type: 'radio',
